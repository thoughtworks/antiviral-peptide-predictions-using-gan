...
params = ['aa_counts', 'aa_percentages', 'molecular_weight', 'aromaticity', 'instability_index', 'isoelectric_point', 'sec_struc', 'helix', 'turn', 'sheet', 'epsilon_prot', 'with_reduced_cysteines', 'with_disulfid_bridges', 'gravy', 'flexibility']
...
for seq in sequences.Sequence:
  ...
  row = pd.DataFrame([[aa_counts, aa_percentages, molecular_weight, aromaticity, instability_index, isoelectric_point, sec_struc, helix, turn, sheet, epsilon_prot,with_reduced_cysteines, with_disulfid_bridges, gravy,flexibility]], columns = params)
...
sns.distplot(seq_properties.molecular_weight, color="g", label="Real", **kwargs)
plt.legend()
...
plt.figure(figsize=(10,7), dpi= 80)
sns.distplot(seq_properties.aromaticity, color="g", label="Real", **kwargs)
plt.legend()
...
plt.figure(figsize=(10,7), dpi= 80)
sns.distplot(seq_properties.instability_index, color="g", label="Real", **kwargs)
plt.legend()
...
plt.figure(figsize=(10,7), dpi= 80)
sns.distplot(seq_properties.isoelectric_point, color="g", label="Real", **kwargs)
# sns.distplot(seq_properties.isoelectric_point, color="r", label="Generated", **kwargs)
plt.legend()
# plt.xlim(-0.25,0.75)
...
plt.figure(figsize=(10,7), dpi= 80)
sns.distplot(seq_properties.helix, color="g", label="Real", **kwargs)
plt.legend()
...
plt.figure(figsize=(10,7), dpi= 80)
sns.distplot(seq_properties.turn, color="g", label="Real", **kwargs)
plt.legend()
...
plt.figure(figsize=(10,7), dpi= 80)
sns.distplot(seq_properties.sheet, color="g", label="Real", **kwargs)
plt.legend()
...
plt.figure(figsize=(10,7), dpi= 80)
sns.distplot(seq_properties.with_reduced_cysteines, color="g", label="Real", **kwargs)
plt.legend()
...
plt.figure(figsize=(10,7), dpi= 80)
sns.distplot(seq_properties.with_disulfid_bridges, color="g", label="Real", **kwargs)
plt.legend()
...
plt.figure(figsize=(10,7), dpi= 80)
sns.distplot(seq_properties.gravy, color="g", label="Real", **kwargs)
plt.legend()
plt.title("gravy  ")
